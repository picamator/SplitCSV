...
class FileTest extends BaseTest
{
     ...
     */
    public function testSplitBy($source_path, $destination_path, RuleInterface $rule, $exptected_parts)
    {
        // get full path
    ...
    public function providerSplitBy()
    {
        return array(
            array(
               'test-10000-rows-357kb.csv', 
               'parts', 
                new FileSize(array('size' => '100kb')), 
                4
            ),
           ...
           array(
               'test-10000-rows-357kb.csv', 
               'parts', 
               new NumberRow(array('number_row' => 10)), 
               1000
           )
        );
    }
